...
def pytest_addoption(parser):
    ...
    parser.addoption('--platform', action='store', dest='platform',
                          default='LINUX',
                          help="""Designates the platform used by the test.
                          {WINDOWS|XP|VISTA|MAC|LINUX|UNIX|ANDROID} Default:LINUX""")


    parser.addoption('--selenium-server', action='store', dest='selenium_server',
                          default=False,
                          help="""Designates the server used by the test.
                               Default: localhost.""")
    
    parser.addoption('--selenium-port', action='store', dest='selenium_port',
                          default='4444',
